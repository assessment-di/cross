...
const OpenedTaxReturnPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <OpenedTaxReturnSectionBase title={formatMessage({ id: 'openedTaxTitle2' })} titleIcon="wallet" isReadonly={isReadonly}>
        {revenues.map((revenue) => (
          <RevenueCard key={revenue.id} {...revenue} isReadonly={isReadonly} />
        ))}
      </OpenedTaxReturnSectionBase>

      <OpenedTaxReturnSectionBase title={formatMessage({ id: 'openedTaxTitle3' })} titleIcon="home" isReadonly={isReadonly}>
        {assets.realEstate.map((realEstate) => (
          <RealEstateCard key={realEstate.id} {...realEstate} isReadonly={isReadonly} />
        ))}

        {assets.cars ? <CarsCard cars={assets.cars} isReadonly={isReadonly} /> : null}
      </OpenedTaxReturnSectionBase>

      <OpenedTaxReturnSectionBase title={formatMessage({ id: 'openedTaxTitle4' })} titleIcon="receipt" isReadonly={isReadonly}>
        {debts.loan ? <LoanCard {...debts.loan} isReadonly={isReadonly} /> : null}
        ...
        {debts.otherDebts ? (
          <OtherDebtsCard otherDebts={debts.otherDebts} {...debts.loan} isReadonly={isReadonly} />
        ) : null}
      </OpenedTaxReturnSectionBase>
